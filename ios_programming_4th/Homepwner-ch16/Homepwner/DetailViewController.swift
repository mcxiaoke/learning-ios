...
class DetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let nameMap:[String: UIView] = [
            "imageView": self.imageView,
            "dateLabel": self.dateLabel,
            "toolBar": self.toolBar
        ]
        
        let hc = NSLayoutConstraint.constraints(withVisualFormat: "H:|-0-[imageView]-0-|",
                                                options: [],
                                                metrics: nil,
                                                views: nameMap)
        let vc = NSLayoutConstraint.constraints(withVisualFormat: "V:[dateLabel]-8-[imageView]-8-[toolBar]",
                                                options: [],
                                                metrics: nil,
                                                views: nameMap)
